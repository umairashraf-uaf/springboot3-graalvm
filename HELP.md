...
* The original package name 'de.heide.springboot-graalvm' is invalid and this project uses 'de.heide.springboot_graalvm' instead.
...
```
$ docker run --rm springboot-graalvm:0.0.1-SNAPSHOT
```
